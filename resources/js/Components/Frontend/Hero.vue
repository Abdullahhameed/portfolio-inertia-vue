        ...
        <div class="container mx-auto h-full" v-motion :initial="{
            ...
            <div class="flex flex-col md:flex-row items-center h-full pt-8">
                <div class="flex-1 flex flex-col items-center lg:items-start">
                    <p class="text-lg text-accent text-md mb-[22px]">Hey, I'm Abdullah!</p>
                    <h1
                    ...
                    <p class="pt-4 pb-8 md:pt-6 md:pb-12 max-w-[480px] text-lg text-center lg:text-left">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius ipsum ipsam hic aliquid.
                    </p>
                    <button
                        class="btn btn-md bg-accent hover:bg-light-secondary hover:text-light-tail-500 dark:hover:bg-dark-secondary dark:hover:text-dark-navy-100 md:btn-lg transition-all">Work
                        with me
                    </button>
                    <div class="pt-12">
                        <h5
                            class="text-lg justify-center lg:justify-start flex items-center text-black dark:text-white mb-2">
                            Follow me on
                        </h5>
                        <div class="flex items-center mb-6">
                            <a class="w-12 h-12 rounded-full flex items-center justify-center border border-white
                                                text-black dark:text-white hover:bg-light-secondary hover:border-light-secondary 
                ...
                <img class="rounded-lg" src="http://portfolio.local/image/hero.jpeg" alt="" />
            </div>
        </div>
    </div>
</section></template>