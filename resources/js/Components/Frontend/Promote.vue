        ...
        <div class="container mx-auto py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-16 lg:px-8">
            ...
            <div class="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                <div class="inline-flex rounded-md shadow">
                    ...
                    inline-flex items-center justify-center rounded-md border border-transparent bg-light-secondary dark:bg-dark-secondary
                    px-5 py-3 text-base font-medium text-dark-primary dark:text-white hover:bg-light-primary dark:hover:bg-dark-primary">Get the Course</a>
                </div>
            </div>
        </div>
    </div>
